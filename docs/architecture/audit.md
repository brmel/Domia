...
> Whole-repo signals here; the **per-subsystem** class/UML views (apps, agents/ADK, tools/plugins, persistence/history, CLI, logging, testing) + size map live in `design.md`.
