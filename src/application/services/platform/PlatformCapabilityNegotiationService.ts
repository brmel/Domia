...
const MATRIX: Record<BuiltInPlatformType, Record<Capability, Support>> = {
    ...
    android:  { navigate: 'unsupported', locate: 'degraded', interact: 'degraded', extract: 'degraded', validate: 'degraded', 'app-control': 'supported', 'system-control': 'unsupported' },
    ios:      { navigate: 'unsupported', locate: 'degraded', interact: 'degraded', extract: 'degraded', validate: 'degraded', 'app-control': 'supported', 'system-control': 'unsupported' },
};
